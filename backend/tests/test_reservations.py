...
class TestReservations:
    ...
    def test_non_owner_cannot_confirm_reservation(
        self, db_session, test_user, test_book, test_location
    ):
        other_user = User(
            username="other",
    ...
    def test_cancel_pending_reservation_by_borrower(
        self, db_session, test_user, test_book, test_location
    ):
        reservation_data = ReservationCreate(
            book_id=test_book.id,
    ...
    def test_cancel_pending_reservation_by_owner(
        self, db_session, test_user, test_book, test_location
    ):
        reservation_data = ReservationCreate(
            book_id=test_book.id,
    ...
    def test_cancel_confirmed_reservation_by_borrower(
        self, db_session, test_user, test_book, test_location
    ):
        reservation_data = ReservationCreate(
            book_id=test_book.id,
    ...
    def test_get_reservation_by_id_with_access(
        self, db_session, test_user, test_book, test_location
    ):
        reservation_data = ReservationCreate(
            book_id=test_book.id,
